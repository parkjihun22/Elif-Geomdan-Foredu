...
const BusinessGuide2 = () => {
    ...
    return (
        ...
        <p className={styles.screenReaderOnly}>
          엘리프 검단 포레듀의 분양(청약) 일정을 한곳에서 확인하세요.
        ...
        <div className={styles.textBox}>
          ...
          <div>엘리프 검단 포레듀, 분양일정을 확인하세요.</div>
        </div>
            ...
            <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="엘리프검단포레듀분양일정안내-image1" />
