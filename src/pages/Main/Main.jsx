...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `쾌적한 단지 스케일`,
    text2: `총 669세대 엘리프 검단 포레듀<br/>
            지하 3층~지상 15층 · 11개동 구성`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `확장되는 교통 프리미엄`,
    text2: `광역 도로망과 인천·김포·서울 접근성<br/>
            GTX-D 등 미래 교통망 확장 기대`,
  ...
  },
  {
    ...
    text2: `단지 인접 공원과 수변 산책로<br/>
            여유로운 일상을 누리는 숲세권 라이프`,
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTitleBox}>
              <div className={styles.mainImageText}>검단이 기다린 새로운 주거 기준</div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 검단신도시 핵심 입지, 인천·김포·서울로 이어지는 광역 접근성<br />
                  - 대형마트·상업시설·의료 인프라를 가까이 누리는 편리한 생활 환경<br />
                  - 단지 인접 공원과 수변 산책로, 자연이 어우러진 쾌적한 주거 여건<br />
                  - 총 669세대 중저층 단지와 특화된 커뮤니티 구성
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="엘리프검단포레듀브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>엘리프검단포레듀</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/xrebjlla"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="엘리프검단포레듀오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="엘리프검단포레듀mobilemain-image1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
            <div className={styles.mainImageTextSub1}>
              검단신도시의 새로운 시작<br/> 기대되는 미래가치<br/>
              브랜드 신뢰 ELIF
              <br />
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 엘리프검단포레듀에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="엘리프검단포레듀모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="엘리프검단포레듀브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="엘리프검단포레듀오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
