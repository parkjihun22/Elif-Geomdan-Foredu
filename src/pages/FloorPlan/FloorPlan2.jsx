...
import page1 from "../../assets/FloorPlan/FloorPlan2/unit_64b.jpg"

const FloorPlan2 = () => {
	const menuContents = [
		{ title: "64A", url: "/FloorPlan/59A" },
		{ title: "64B", url: "/FloorPlan/59B" },
	...
	return (
		<div className={styles.container}>
			...
			<div>엘리프 검단 포레듀가 자부심으로 완성됩니다.</div>
			</div>
