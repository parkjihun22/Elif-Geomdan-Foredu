...
const ComplexGuide1 = () => {
  ...
  return (
    ...
    <Helmet>
      <title>엘리프 검단 포레듀 - 청약안내</title>
      <meta
        name="description"
        content="엘리프 검단 포레듀 청약안내를 한눈에 확인하세요. 특별공급·1·2순위 청약 일정, 자격요건, 필요서류와 인터넷 청약 절차를 안내합니다."
      />
      <link rel="canonical" href="https://www.ds-elifapt.com/SalesInfo/SubscriptionGuide" />
    ...
    <p className={styles.screenReaderOnly}>
      ...
      청약 절차를 단계별로 따라 정확하게 신청하세요.
    </p>

    <div className={styles.textBox}>
      <div>인터넷 청약 방법을 확인하세요</div>
      <div>엘리프 검단 포레듀, 소중한 기회를 놓치지 마세요</div>
    </div>
